...
\begin{figure}
    ...
    \setlength{\belowcaptionskip}{0pt}
        \center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig1.pdf}}
...
\begin{figure}
    \setlength{\abovecaptionskip}{-1pt}
    \setlength{\belowcaptionskip}{0pt}
        \center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig2.pdf}}
...
\begin{figure}
    \setlength{\abovecaptionskip}{-1pt}
    \setlength{\belowcaptionskip}{0pt}
        \center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig3.pdf}}
...
\begin{figure}
    ...
    \setlength{\belowcaptionskip}{0pt}
        \center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig4.pdf}}
...
\begin{figure}
    ...
    \setlength{\belowcaptionskip}{0pt}
        \center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig6.pdf}}
...
\begin{figure}
    ...
    \setlength{\belowcaptionskip}{0pt}
        \center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig7.pdf}}
...
\begin{figure}[tb]
    ...
    \setlength{\belowcaptionskip}{-10pt}
        \center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig8.pdf}}
...
\setlength{\abovecaptionskip}{-2pt}
\setlength{\belowcaptionskip}{0pt}
	\center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig9.pdf}}
...
\setlength{\belowcaptionskip}{-2pt}
	\center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig10.pdf}}
...
\setlength{\abovecaptionskip}{-10pt}
\setlength{\belowcaptionskip}{-2pt}
	\center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig11.pdf}}
...
\setlength{\belowcaptionskip}{-20pt}
	\center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig12.pdf}}
...
\setlength{\abovecaptionskip}{-2pt}
\setlength{\belowcaptionskip}{-10pt}
	\center{\includegraphics[width=0.5\linewidth]{images/HyCA-fig13.pdf}}
...
\setlength{\abovecaptionskip}{-10pt}
\setlength{\belowcaptionskip}{0pt}
	\center{\includegraphics[width=0.65\linewidth]{images/HyCA-fig14.pdf}}
...
\setlength{\abovecaptionskip}{-10pt}
\setlength{\belowcaptionskip}{0pt}
	\center{\includegraphics[width=0.6\linewidth]{images/HyCA-fig15.pdf}}
...
\begin{algorithm} 
    ...
    \KwData{faulty weight values $W_0$, previous stored golden feature maps $o_G$,  loss function $L$, training block set $B$}
    \KwResult{updated fault-tolerant weights $W_{i}$}
...
For permanent fault detection, as shown in Figure \ref{fig:mlc-hard}, the ``Origin'' method can hardly differentiate the faulty models from original models, but the AET method achieves more than 97\% detection accuracy with the elaborately generated adversarial example.  
