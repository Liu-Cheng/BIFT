...
\begin{figure}[t]
\centering \subfigure[XOR Tree] {\includegraphics[width=0.55\textwidth, height=0.33\textwidth]{fig2-7a}}
...
\begin{figure}
\centering 
\subfigure[Area overhead and associated overhead breakdown] {\includegraphics[width=0.6\textwidth]{fig2-9a}} 
\subfigure[Power overhead and associated overhead breakdown] {\includegraphics[width=0.6\textwidth]{fig2-9b}}
