...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.3\textwidth]{ZD-fig1}
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.2\textwidth]{ZD-fig3}
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.4\textwidth]{ZD-fig4}
...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.5\textwidth]{TR-fig1}
...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.55\textwidth]{TR-fig2}
...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.65\textwidth]{TR-fig3}
...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.65\textwidth]{TR-fig4}
...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.7\textwidth]{TR-fig5}
...
$[Topology\ Reconfiguration\ Problem (TRP)]:$ For an $R \times C$ homogeneous manycore processor with $S$ redundant cores, suppose $D$ cores $(D \leq S)$   are faulty, construct $R \times C$ coordinates as follows:\\
 ...
 \begin{figure}[t]
     \centering
         \includegraphics[width=0.7\textwidth]{TR-fig6}
...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.65\textwidth]{TR-fig7}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\textwidth]{TR-fig8}
...
\begin{figure}[t]
      \centering
        \includegraphics[width=0.55\textwidth]{TR-fig9}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.55\textwidth]{TR-fig10}
...
For example, consider a physical topology with 6 $\times$ 6 2D mesh reference topology and 5 spare cores located on the righthand side and 5 faulty cores, as shown in Figure \ref{fig10}(a). The virtual topology achieved by RRCS is shown in Figure \ref{fig10}(b), in which the coordinates indicates the virtual locations for the corresponding cores. Reconfiguration begins from row R3, causing two stealing operations, i.e., the two CS1 from row R4. R4 then does not have enough available cores and has to steal another two cores, i.e., CS2 from row R5. The process continues until the last row R0 is configured. Note that CS3 borrows relatively distant cores to configure faulty cores in row R5. These chain column stealing operations will generate an undesirable virtual topology.
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.65\textwidth]{TR-fig11}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.6\textwidth]{TR-fig12}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.5\textwidth]{TR-fig13}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.5\textwidth]{TR-fig14}
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.55\textwidth]{ZD-fig5}
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.25\textwidth]{ZD-fig6}
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.98\textwidth]{ZD-fig8}
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.98\textwidth]{ZD-fig9}
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.98\textwidth]{ZD-fig10}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=\textwidth]{DPS-fig3}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=\textwidth]{DPS-fig4}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.55\textwidth]{DPS-fig5}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.5\textwidth]{DPS-fig6}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.5\textwidth]{DPS-fig7}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.65\textwidth]{DPS-fig8}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.65\textwidth]{DPS-fig9}
...
\begin{figure}[h]
      \centering
        \includegraphics[width=0.65\textwidth]{DPS-fig10}
