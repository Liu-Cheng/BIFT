...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.65\textwidth]{IPCDegradation}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{IVF-fig4}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{IVF-fig5}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\textwidth]{IVF-fig6}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\textwidth]{IVF-fig7}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{IVF-fig8}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{IVF-fig9}\\
...
\begin{table}
    ...
    \begin{tabular}{@{}lcccc}
        \toprule
                  & \begin{tabular}[c]{@{}c@{}}Fetch/Slot/Issue \\ Width\end{tabular} & \begin{tabular}[c]{@{}c@{}}Commit \\ Width\end{tabular} & \begin{tabular}[c]{@{}c@{}}Reorder Buffer\\  Size\end{tabular} & \begin{tabular}[c]{@{}c@{}}Simulated \\ Workloads\end{tabular}                                                                                       \\ 
                  \midrule
        rob\_base & 4                                                                 & 11                                                      & 80                                                             & \multirow{4}{*}{\begin{tabular}[c]{@{}c@{}}All twelve \\ SPEC CPU2000 \\ integer benchmarks\end{tabular}} \\
        rob\_c1   & 4                                                                 & 11                                                      & 40                                                             &                                                                                                           \\
        rob\_c2   & 4                                                                 & 11                                                      & 120                                                            &                                                                                                           \\
        rob\_c3   & 2                                                                 & 5                                                       & 80                                                             &                                                                                                           \\ 
        \bottomrule
  ...
  \setlength{\tabcolsep}{3mm}
    ...
    \begin{tabular}{@{}lcccc}
        \toprule
                  & \begin{tabular}[c]{@{}c@{}}Fetch/Slot/Issue \\ Width\end{tabular} & \begin{tabular}[c]{@{}c@{}}Commit \\ Width\end{tabular} & \begin{tabular}[c]{@{}c@{}}Reorder Buffer\\  Size\end{tabular} & \begin{tabular}[c]{@{}c@{}}Simulated \\ Workloads\end{tabular}                                                                                        \\ 
                  \midrule
         reg\_base & 4 & 11 & 80 & \multirow{4}{*}{\begin{tabular}[c]{@{}c@{}}All twelve \\ SPEC CPU2000 \\ integer benchmarks\end{tabular}} \\
         reg\_c1 & 4 & 11 & 60 &  \\
         reg\_c2 & 4 & 11 & 120 & \\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\textwidth]{IVF-fig15}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\textwidth]{IVF-fig16}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\textwidth]{IVF-fig17}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\textwidth]{IVF-fig18}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\textwidth]{IVF-fig19}\\
...
\begin{figure}[t]
      \centering
      \includegraphics[width=0.6\textwidth]{dist4}\\
...
\begin{figure*}[t]
    \centering
    \subfigure{\includegraphics[width=0.45\textwidth]{SnippetDistributionlatest}}
    \subfigure{\includegraphics[width=0.45\textwidth]{NewSnippetDeviationTolerance}}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.7\textwidth]{granularity}\\
...
\begin{figure*}[t]
\centering
\subfigure{\includegraphics[width=0.45\textwidth]{InstructionActivities}}
\subfigure{\includegraphics[width=0.45\textwidth]{SnippetSizeDistribution}}
...
\begin{figure}[t]
  ...
  \centering
  \includegraphics[width=0.65\textwidth]{NewSnippetDeviationToleranceVariation}\\
...
\begin{figure}[t]
  % Requires \usepackage{graphicx}
  \centering
  \includegraphics[width=0.7\textwidth]{NewSnippetFaultDeviationLatest}\\
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.75\textwidth]{IPCPredictionAndCoverage}\\
...
\begin{figure*}[t]
  % Requires \usepackage{graphicx}
  \centering
  \includegraphics[width=0.95\textwidth]{imple2}\\
...
\begin{figure}[t]
  % Requires \usepackage{graphicx}
  \centering
  \includegraphics[width=0.6\textwidth]{mux1}\\
...
\begin{figure}[t]
  % Requires \usepackage{graphicx}
  \centering
  \includegraphics[width=0.65\textwidth]{bloomfilter2}\\
...
\begin{figure}[t]
  % Requires \usepackage{graphicx}
  \centering
  \includegraphics[width=0.65\textwidth]{evalu_bf}\\
...
\begin{figure}[t]
  % Requires \usepackage{graphicx}
  \centering
  \includegraphics[width=0.75\textwidth]{hashtable2}\\
...
\begin{figure}[t]
  % Requires \usepackage{graphicx}
  \centering
  \includegraphics[width=0.6\textwidth]{Result_Hash}\\
...
\begin{figure*}[t]
 ...
 \centering
  \includegraphics[width=0.8\textwidth]{MediumDegradationWithAndWithoutCoreRank41}\\
...
\begin{figure*}[t]
 \centering
  \includegraphics[width=1\textwidth]{Figure14DegradationLevelwithoutCoreRank41}\\
...
\begin{figure*}[t]
 \centering
  \includegraphics[width=1\textwidth]{Figure15DegradationLevelwithCoreRank31}\\
...
\begin{figure*}[t]
 \centering
  \includegraphics[width=0.8\textwidth]{Defect-awareCoreRank}\\
...
\begin{figure}[t]
 \centering
  \includegraphics[width=0.75\textwidth]{fastCoreAndCoreRankComparision}\\
